        ...
        <div class="au-card m-b-30">
            <div class="au-card-inner">
                <div class="table-responsive table-responsive-data2">
                    <form action="{{ route('updateeditprofilereseller' , $user->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="typeUser" type="typeUser"
                                    class="form-control @error('typeUser') is-invalid @enderror" name="typeUser"
                                    value="{{ $user->typeUser }}" required autocomplete="typeUser" readonly>
