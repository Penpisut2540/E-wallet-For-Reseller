...
@section('content')
@if(!empty(Session::get('error_code6')) && Session::get('error_code6') == 6)
<script>
...
<div class="row justify-content-center">
    <div class="col-md-7">
        <!-- DATA TABLE -->
        <h3 class="title-5 m-b-35">Profile User</h3>
        @if (session('status'))
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('updateeditprofilereseller' , Auth::user()->id ) }}" method="POST">
                    @csrf
                    @method('PUT')
