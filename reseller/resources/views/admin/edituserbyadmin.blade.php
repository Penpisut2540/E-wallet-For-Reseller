...
@section('title','Edit User by Admin')
@section('content')
        ...
        <div class="au-card m-b-30">
            <div class="au-card-inner">
                <div class="table-responsive table-responsive-data2">
                    <form action="{{ route('updateedituserbyadmin' , $user->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tel" type="text" class="form-control @error('tel') is-invalid @enderror"
                                    name="tel" value="{{ $user->tel }}" required autocomplete="tel" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="typeUser"
                                class="col-md-4 col-form-label text-md-right">{{ __('TypeUser') }}</label>
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="typeUser" id="typeUser" type="typeUser"
                                    ...
                                    value="{{ $user->typeUser}}" required autocomplete="typeUser" autofocus>
                                    @if( $user->typeUser == "RESELLER")
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="au-btn au-btn-icon au-btn--blue au-btn--small">
                                    <i class="fas fa-save"></i>{{ __(' Save Edit') }}
                                </button>
                            </div>
                        </div>
                    </form>
